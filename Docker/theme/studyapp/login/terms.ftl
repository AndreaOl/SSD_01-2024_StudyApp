...
<@layout.registrationLayout displayMessage=false; section>
    <#if section = "header">
        ${msg("termsTitle")}
    <#elseif section = "form">
    <div id="kc-terms-text" style="height: 300px; overflow-y: auto;">
        <h2><strong>AGREEMENT TO OUR LEGAL TERMS</strong></h2>
        <p>We are <strong>StudyApp</strong> ("Company," "we," "us," "our").</p>
        <p>We operate the website https://ssdstudyapp.northeurope.cloudapp.azure.com/ (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
        <p>You can contact us by email at studyapp806@gmail.com.</p>
        <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and StudyApp, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
        <p>We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by studyapp806@gmail.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
        ...
        <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: studyapp806@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
        ...
        <ul style="padding-left: 30px; list-style-type:disc;">
            ...
            <li>Use names for the user profile, sessions, groups or any other feature provided by the website that include any offensive comments that are connected to race, national origin, gender, sexual preference, or physical handicap.</li>
        </ul>
        ...
        <h2><strong>8. THIRD-PARTY WEBSITES AND CONTENT</strong></h2>
        ...
        <h2><strong>9. SERVICES MANAGEMENT</strong></h2>
        ...
        <p>We care about data privacy and security. By using the Services, you agree to be bound by our Privacy Policy posted on the Services, which is incorporated into these Legal Terms. Please be advised the Services are hosted in Ireland. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Ireland, then through your continued use of the Services, you are transferring your data to Ireland, and you expressly consent to have your data transferred to and processed in Ireland.</p>


        <h2><strong>11. TERM AND TERMINATION</strong></h2>
        ...
        <h2><strong>12. MODIFICATIONS AND INTERRUPTIONS</strong></h2>
        ...
        <p>These Legal Terms are governed by and interpreted following the laws of Italy, and the use of the United Nations Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law in your country to residence. StudyApp and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Campania, which means that you may make a claim to defend your consumer protection rights in regards to these Legal Terms in Italy, or in the EU country in which you reside.</p>
        ...
        <h2><strong>15. CORRECTIONS</strong></h2>
        ...
        <h2><strong>17. LIMITATIONS OF LIABILITY</strong></h2>
        ...
        <p><strong>StudyApp</strong></p>
        <p><strong>studyapp806@gmail.com</strong></p>
    </div>
